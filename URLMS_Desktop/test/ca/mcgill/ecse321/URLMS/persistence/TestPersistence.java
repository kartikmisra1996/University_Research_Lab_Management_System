...
public class TestPersistence {
	...
	public void setUp() throws Exception {
		...
		try{
			testCtrl.createEmployee("Edinson Cavani", "Forward","Research Associate", 40000000, 123456789);
		}
		catch(Exception e){
			error = error + e.getMessage();
		}
		try{
			testCtrl.createEmployee("Angel Di Maria", "Right Wing", "Research Assistant", 35000000, 987654321);
		}
		catch(Exception e){
			error = error + e.getMessage();
		}
